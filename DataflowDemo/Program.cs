...
namespace DataflowDemo
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // DataStructure_BatchBlock();
            //DataStructure_JoinBlock();
            //DataStructure_BatchedJoinBlock();

            //DataStructure_ActionBlock();
            //DataStructure_TransformBlock();
            //DataStructure_TransformManyBlock();


            DataStructure_BroadcastBlock();
            DataStructure_WriteOnceBlock();
            //DataStructure_BufferBlock();
            // DataStructure_BroadcastBlock();
        ...
        #region Dataflow  Data Structure

        #region Buffering Blocks
        ...
        private static void DataStructure_BroadcastBlock()
        {
        ...
        private static void DataStructure_BufferBlock()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                Console.WriteLine("bufferBlock2");
                Console.WriteLine(bufferBlock2.Receive());//输出5（唯一一个元素）后，直接阻塞
            }
        }
        ...
        private static void DataStructure_BatchBlock()
        {
            ...
            batchBlock.Complete(); //如果不是用Complete方法，将导致只能计算 batch 1的结果
        ...
        private static void DataStructure_JoinBlock()
        {
        ...
        private static void DataStructure_BatchedJoinBlock()
        {
